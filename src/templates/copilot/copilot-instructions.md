# Project Configuration for GitHub Copilot

This project uses **Musuhi** - a Specification Driven Development (SDD) agent system with 19 specialized AI agents.

## Available Agents

This project has 19 specialized agents installed in `.github/agents/`. Each agent is an expert in a specific domain of software development.
...
You can customize agent behavior by editing the markdown files in `.github/agents/`:
...
- **Documentation**: See `.github/README.md` for agent details
- **Agent Files**: Browse `.github/agents/*.md` for individual agent prompts
