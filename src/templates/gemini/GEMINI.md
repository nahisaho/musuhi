...
This project uses **Musuhi** with 20 specialized AI agents for Specification Driven Development with Gemini CLI.
...
This project has 20 specialized agents in `.gemini/agents/`:
...
### First Time Setup
```
1. Generate project memory with steering agent
...
```
Use the orchestrator agent to coordinate multi-agent workflows
```

### For Specific Tasks
```
Use requirements-analyst to create requirements for features
Use system-architect to design architecture based on requirements.md
Use software-developer to implement components following design.md
Use test-engineer to generate tests from requirements.md
```
