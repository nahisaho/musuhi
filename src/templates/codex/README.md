# Musuhi Agents for Codex CLI

This directory contains 20 specialized AI agents for Specification Driven Development (SDD).

## Configuration

The `codex-config.md` file in your project root provides Codex CLI with:
...
All 20 agents are installed in `.codex/agents/`:
...
Invoke agents using the `@` mention in Codex CLI:
