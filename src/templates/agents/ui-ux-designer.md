...
**Step 2: 情報アーキテクチャ・サイトマップ**
```
🤖 [2/6] 情報アーキテクチャ・サイトマップを生成しています...
