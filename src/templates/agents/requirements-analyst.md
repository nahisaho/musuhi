...
**Step 1: SRS（ソフトウェア要求仕様書）**
```
🤖 [1/5] ソフトウェア要求仕様書（SRS）を生成しています...

📝 英語版を作成: ./docs/requirements/srs/srs-[project-name]-v1.0.md
✅ 英語版の保存が完了しました

📝 日本語版を作成: ./docs/requirements/srs/srs-[project-name]-v1.0.ja.md
✅ 日本語版の保存が完了しました
...
📝 英語版を作成: ./docs/requirements/functional/functional-requirements-[project-name]-20251112.md
✅ 英語版の保存が完了しました

📝 日本語版を作成: ./docs/requirements/functional/functional-requirements-[project-name]-20251112.ja.md
✅ 日本語版の保存が完了しました
...
📝 英語版を作成: ./docs/requirements/non-functional/non-functional-requirements-20251112.md
✅ 英語版の保存が完了しました

📝 日本語版を作成: ./docs/requirements/non-functional/non-functional-requirements-20251112.ja.md
✅ 日本語版の保存が完了しました
...
**Step 4: ユーザーストーリー**
```
🤖 [4/5] ユーザーストーリーを生成しています...

📝 英語版を作成: ./docs/requirements/user-stories/user-stories-[feature]-20251112.md
✅ 英語版の保存が完了しました

📝 日本語版を作成: ./docs/requirements/user-stories/user-stories-[feature]-20251112.ja.md
✅ 日本語版の保存が完了しました

[4/5] 完了。次のドキュメントに進みます。
```

**Step 5: トレーサビリティマトリクス**
```
🤖 [5/5] トレーサビリティマトリクスを生成しています...

📝 英語版を作成: ./docs/requirements/traceability-matrix-20251112.md
✅ 英語版の保存が完了しました

📝 日本語版を作成: ./docs/requirements/traceability-matrix-20251112.ja.md
✅ 日本語版の保存が完了しました
...
📄 ./docs/requirements/functional/functional-requirements-[project-name]-20251112.md (English)
📄 ./docs/requirements/functional/functional-requirements-[project-name]-20251112.ja.md (Japanese)
📄 ./docs/requirements/non-functional/non-functional-requirements-20251112.md (English)
📄 ./docs/requirements/non-functional/non-functional-requirements-20251112.ja.md (Japanese)
📄 ./docs/requirements/user-stories/user-stories-[feature]-20251112.md (English)
📄 ./docs/requirements/user-stories/user-stories-[feature]-20251112.ja.md (Japanese)
📄 ./docs/requirements/traceability-matrix-20251112.md (English)
📄 ./docs/requirements/traceability-matrix-20251112.ja.md (Japanese)
