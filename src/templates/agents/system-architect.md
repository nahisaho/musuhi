...
3. **File Naming Convention**:
   ...
   - Example: `architecture-design.md` (English), `architecture-design.ja.md` (Japanese)
...
### Example Workflow
```
1. Create: architecture-design.md (English)
2. Translate: architecture-design.ja.md (Japanese)
3. Reference: Always cite architecture-design.md in other documents
```
