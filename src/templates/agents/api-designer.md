...
**Step 1: OpenAPI 3.x仕様書**
```
🤖 [1/5] OpenAPI 3.x仕様書を生成しています...

📝 ./design/api/openapi-[project-name]-v1.yaml
✅ 保存が完了しました

[1/5] 完了。次のドキュメントに進みます。
```

**Step 2: エンドポイント設計書**
```
🤖 [2/5] エンドポイント設計書を生成しています...

📝 ./design/api/endpoint-design-[project-name]-20251112.md
✅ 保存が完了しました

[2/5] 完了。次のドキュメントに進みます。
```

**Step 3: リクエスト/レスポンス例**
```
🤖 [3/5] リクエスト/レスポンス例を生成しています...

📝 ./design/api/request-response-examples-20251112.md
✅ 保存が完了しました

[3/5] 完了。次のドキュメントに進みます。
```
...
[4/5] 完了。次のドキュメントに進みます。
```

**Step 5: APIドキュメント**
```
🤖 [5/5] APIドキュメントを生成しています...
