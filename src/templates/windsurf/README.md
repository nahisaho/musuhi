# Musuhi Agents for Windsurf IDE

This directory contains 20 specialized AI agents for Specification Driven Development (SDD).

## Configuration

The `.windsurfrules` file in your project root provides Windsurf with:
...
All 20 agents are installed in `.windsurf/agents/`:
...
Invoke agents using the `@` mention in Windsurf:
