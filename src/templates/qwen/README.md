# Musuhi Agents for Qwen Code

This directory contains 20 specialized AI agents for Specification Driven Development (SDD).

## Configuration

The `qwen-config.md` file in your project root provides Qwen Code with:
...
All 20 agents are installed in `.qwen/agents/`:
...
Invoke agents using the `@` mention in Qwen Code:
